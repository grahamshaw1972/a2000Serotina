...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_HASH, KC_P4,   KC_P5,   KC_P6,
        KC_LSFT, KC_BSLS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,
        KC_COMM, KC_DOT,  KC_SLSH, KC_LSFT, KC_UP,   KC_P1,   KC_P2,   KC_P3,   KC_PENT,
        KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,  KC_RALT, KC_RGUI, KC_MENU,
        KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT, KC_INS,  KC_DEL
    ),
