...
#define STM32_PLLN_VALUE                    ${doc.STM32_PLLN_VALUE!"384"}
...
#define STM32_PLLI2SSRC                     ${doc.STM32_PLLI2SSRC!"STM32_PLLI2SSRC_PLLSRC"}
#define STM32_I2SCKIN_VALUE                 ${doc.STM32_I2SCKIN_VALUE!"0"}
#define STM32_PLLI2SM_VALUE                 ${doc.STM32_PLLI2SM_VALUE!"8"}
...
#define STM32_PLLI2SDIVR_VALUE              ${doc.STM32_PLLI2SDIVR_VALUE!"1"}
#define STM32_PLLDIVR_VALUE                 ${doc.STM32_PLLDIVR_VALUE!"1"}
#define STM32_SAI1SEL                       ${doc.STM32_SAI1SEL!"STM32_SAI1SEL_OFF"}
#define STM32_SAI2SEL                       ${doc.STM32_SAI2SEL!"STM32_SAI2SEL_OFF"}
#define STM32_TIMPRE                        ${doc.STM32_TIMPRE!"STM32_TIMPRE_PCLK"}
...
#define STM32_SPI_SPI4_RX_DMA_STREAM        ${doc.STM32_SPI_SPI4_RX_DMA_STREAM!"STM32_DMA_STREAM_ID(2, 4)"}
