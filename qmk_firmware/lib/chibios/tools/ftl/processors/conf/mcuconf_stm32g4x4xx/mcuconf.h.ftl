...
#define STM32_ADC_USE_ADC1                  ${doc.STM32_ADC_USE_ADC1!"TRUE"}
#define STM32_ADC_USE_ADC2                  ${doc.STM32_ADC_USE_ADC2!"TRUE"}
#define STM32_ADC_USE_ADC3                  ${doc.STM32_ADC_USE_ADC3!"TRUE"}
#define STM32_ADC_USE_ADC4                  ${doc.STM32_ADC_USE_ADC4!"TRUE"}
...
#define STM32_DAC_DAC3_CH1_IRQ_PRIORITY     ${doc.STM32_DAC_DAC3_CH1_IRQ_PRIORITY!"10"}
#define STM32_DAC_DAC3_CH2_IRQ_PRIORITY     ${doc.STM32_DAC_DAC3_CH2_IRQ_PRIORITY!"10"}
#define STM32_DAC_DAC4_CH1_IRQ_PRIORITY     ${doc.STM32_DAC_DAC4_CH1_IRQ_PRIORITY!"10"}
#define STM32_DAC_DAC4_CH2_IRQ_PRIORITY     ${doc.STM32_DAC_DAC4_CH2_IRQ_PRIORITY!"10"}
